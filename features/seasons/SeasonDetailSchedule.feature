Feature: Season detail
  As an authenticated user,
  I want to be able to view details, standings and other info for a season
  ...
  Scenario: View past season
    ...
    And I am on the "leagues:seasons:schedule" page with kwargs "slug=liahl, season_pk=1"
