Feature: View and revoke api token
  ...
  Background: User account and token exist
    ...
    And "user@ayrabo.com" is completely registered for "Ice Hockey" with role "Coach"
    And I login with "user@ayrabo.com" and "myweakpassword"

  Scenario: View api token
    Given "user@ayrabo.com" has "cb9667fb74360e47d5f9ff266f1389b40fbc46e0" as an api token
