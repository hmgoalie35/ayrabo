...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.create_file(test_models_file_path, 'from escoresheet.utils import BaseTestCase\n')

        # Create test_views file
        test_views_file_path = os.path.join(tests_module_path, 'test_views.py')
        self.create_file(test_views_file_path, 'from escoresheet.utils import BaseTestCase\n')
