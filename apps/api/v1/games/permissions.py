...
class GameRostersRetrieveUpdatePermission(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        # in get_context_data (for normal views) the function can return (result, managers, scorekeepers, ...etc). Can
        # also have a can_user_update_home_team that uses the function above.
